...
export type ContentMeta = { slug: string; title: string; description: string; order?: number; duration?: string; level?: string; subject?: string; category?: string; experienceType?: string; difficulty?: string; color?: string; icon?: string; featured?: boolean; tags?: string[] };
